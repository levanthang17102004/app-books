...
const AppMessage = () => {
    ...
    const facebookUrl = 'https://www.facebook.com/thang.bola.1/'; // Thay đổi đường dẫn URL thành trang Facebook của bạn  
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.container}>
                <Text style={styles.appDescription}>
                    Ứng dụng Le Thang Book là một nền tảng giúp bạn dễ dàng tìm kiếm và đặt sách từ các nhà sách gần bạn.
                </Text>
                <Text style={styles.appDescription}>
                    Với giao diện thân thiện và dễ sử dụng, bạn có thể duyệt qua hàng ngàn cuốn sách và nhà sách chỉ với vài cú chạm.
                </Text>
                <Text style={styles.appDescription}>
                    Chúng tôi cam kết mang đến cho bạn trải nghiệm đặt sách nhanh chóng và tiện lợi nhất.
                </Text>
                <Text style={styles.appDescription}>
