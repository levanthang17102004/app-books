...
const RMain = () => {
    ...
    // Fade-in effect for the bookstore header
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <Animated.FlatList
                ref={flatListRef}
                horizontal
                data={processDataBookstoreMenu(bookstore)}
            ...
            <AnimatedSectionList
                ...
                sections={processDataBookstoreMenu(bookstore)}
                renderItem={({ item, index }: { item: any, index: any }) => {
                    const menuItem = item as IBook
                    return (<ItemQuantity
                        bookstore={bookstore}
                        menuItem={menuItem}
                        isModal={false}
            ...
            <StickyFooter bookstore={bookstore} />
        </View>
    );
};
